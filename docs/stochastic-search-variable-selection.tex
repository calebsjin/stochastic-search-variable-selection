...
\hypersetup{unicode=true,
            pdftitle={Stochastic Search Variable Selection (SSVS)},
...
{\centering \includegraphics[width=0.8\linewidth]{stochastic-search-variable-selection_files/figure-latex/nice-fig-1} 
